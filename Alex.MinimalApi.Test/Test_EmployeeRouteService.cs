...
{
    [TestClass]
    public class Test_EmployeeRouteService
    {
        ...
        /// Constructor
        /// </summary>
        public Test_EmployeeRouteService()
        {
            this.In_Mapper = AutoMapperConfig.ConfigureMaps();
        }

        [TestMethod()]
        public async Task PostAsync_Success_ReturnsEmployee()
        {
            ...
            EmployeeService in_employeeService = new EmployeeService(in_repo.Object);

            EmployeeRouteService employeeRouteService = new EmployeeRouteService(this.In_Mapper!, in_employeeService);
        ...
        public async Task PostAsync_WithNoBody_ReturnsBadRequest()
        {
            ...
            var in_empService = new EmployeeService(in_repo.Object);
            EmployeeRouteService employeeRouteService = new EmployeeRouteService(this.In_Mapper!, in_empService);
